                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('single.category',['id' => $first_post->category->id])}}">{{$second_post->category->name}}</a>
                                        </span>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('single.category',['id' => $first_post->category->id])}}">{{$third_post->category->name}}</a>
                                        </span>
