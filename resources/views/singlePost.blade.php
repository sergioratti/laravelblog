                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="blog-details-author">
                            ...
                            <div class="blog-details-author-thumb">
                                <img src="{{$post->user->profile->avatar}}" alt="Author" width="50px">
                            </div>
                        ...
                        <div class="pagination-arrow">
                            @if($next_post)
                            <a href="{{route('single.post',['slug' => $next_post->slug])}}" class="btn-prev-wrap">
                                <svg class="btn-prev">
                            ...
                            @endif
                            @if($prev_post)
                            <a href="{{route('single.post',['slug' => $prev_post->slug])}}" class="btn-next-wrap">
                                <div class="btn-content">
